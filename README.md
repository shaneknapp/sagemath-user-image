...
This is a proof of concept jupyterhub image for using [SageMath](https://www.sagemath.org/).

See this repository's [CONTRIBUTING.md](https://github.com/cal-icor/sagemath-user-image/blob/main/CONTRIBUTING.md) for instructions. That information will eventually be migrated to docs.datahub.berkeley.edu.
